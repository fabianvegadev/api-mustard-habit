"""Tercer reinicio de tablas

Revision ID: 6149f4daccdc
Revises: 9fbbf8158022
Create Date: 2024-10-19 21:36:58.636730
...
revision = '6149f4daccdc'
down_revision = '9fbbf8158022'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('user_created_date', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
